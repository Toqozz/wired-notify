...
// It has been tweaked to push to a sender.
...
pub trait OrgFreedesktopNotifications {
    ...
    fn notify(&self, sender: Sender<DBusNotification>, app_name: &str, replaces_id: u32, app_icon: &str, summary: &str, body: &str, actions: Vec<&str>, hints: ::std::collections::HashMap<&str, arg::Variant<Box<dyn arg::RefArg>>>, expire_timeout: i32) -> Result<u32, tree::MethodErr>;
